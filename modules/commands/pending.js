...
module.exports.handleReply = async function({ api, event, handleReply, getText }) {
  ...
  const picture = (await axios.get(`https://files.catbox.moe/kd451g.gif`, { responseType: "stream"})).data
