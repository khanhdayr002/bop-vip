...
━━━━━━━━━━━━━━━━━━
🌸 ===『 𝐁𝐨𝐭 』=== 🌸`
        return api.sendMessage({body: msg, attachment: (await axios.get((await axios.get(`https://api-hoangphuong.cutecana.repl.co/girl `)).data.data,  {
                    responseType: 'stream'
                })).data},event.threadID); 
    }