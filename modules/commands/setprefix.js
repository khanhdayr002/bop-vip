...
module.exports.handleEvent=async({event:e,api:a,Threads:n})=>{
  ...
  ["mpre","mprefix","prefix","dấu lệnh","prefix của bot là gì","daulenh","dùng sao","lệnh là gì"].forEach((e=>{let a=e[0].toUpperCase()+e.slice(1);if(s===e.toUpperCase()|s===e|a===s){const e=p.PREFIX||global.config.PREFIX;return null==d.PREFIX?i(`\n[ ${e} ]`):i("\n→ Prefix của nhóm là: "+d.PREFIX)}}))},
