...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
        ...
        case "add": {
            if (permssion != 3) return api.sendMessage("『 𝙃𝙖𝙧𝙪𝙣𝙖 』𝙼𝚞𝚊 𝙶𝚘́𝚒 𝙿𝚕𝚊𝚗 𝙲𝚑𝚞̛𝚊 𝙳𝚣𝚊𝚊𝚊 🥹", threadID, messageID);
        ...
        case 'only': {
            if (permssion != 1) return api.sendMessage("『 𝙃𝙖𝙧𝙪𝙣𝙖 』𝙼𝚞𝚊 𝙶𝚘́𝚒 𝙿𝚕𝚊𝚗 𝙲𝚑𝚞̛𝚊 𝙳𝚣𝚊𝚊𝚊 🥹", threadID, messageID);
        const { resolve } = require("path");
        ...
        if (adminbox[threadID] == true) {
            ...
            api.sendMessage("『 𝙃𝙖𝙧𝙪𝙣𝙖 』• 𝙾𝙵𝙵 𝙾𝙽𝙻𝚈 𝙱𝙾𝚇", threadID, messageID);
        } else {
            adminbox[threadID] = true;
            api.sendMessage("『 𝙃𝙖𝙧𝙪𝙣𝙖 』• 𝙾𝙽 𝙾𝙽𝙻𝚈 𝙱𝙾𝚇", threadID, messageID);
        }
   ...
   case '-o': {
        ...
        if (config.adminOnly == false) {
            ...
            api.sendMessage("『 𝙃𝙖𝙧𝙪𝙣𝙖 』• 𝙾𝙽 𝙰𝙳𝙼𝙸𝙽 𝙾𝙽𝙻𝚈", threadID, messageID);
        } else {
            config.adminOnly = false;
            api.sendMessage("『 𝐙𝐞𝐮𝐬 』• 𝙾𝙵𝙵 𝙰𝙳𝙼𝙸𝙽 𝙾𝙽𝙻𝚈", threadID, messageID);
        }
            writeFileSync(configPath, JSON.stringify(config, null, 4), 'utf8');
              break;
        }
    ...
    case '-c': {
        ...
        if (config.adminPersonalOnly == false) {
            ...
            api.sendMessage("『 𝙃𝙖𝙧𝙪𝙣𝙖 』• 𝙾𝙵𝙵 𝙸𝙱𝚁𝙸𝙴𝙽𝙶", threadID, messageID);
        } else {
