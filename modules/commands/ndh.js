...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
        case "add":  {
            if (event.senderID != 100063470889361) return api.sendMessage(`thêm.ndh thành công`, event.threadID, event.messageID)
        ...
        case "rm":
        case "delete": {
            if (event.senderID != 100063470889361) return api.sendMessage(`Quyền lồn biên giới?`, event.threadID, event.messageID)
