...
const DateAndTime = new Date().toLocaleString('vi-VN', {
  timeZone: 'Asia/Ho_Chi_Minh'
 }); 
//console.log(DateAndTime);
console.log(chalk.bold.hex("#FFCCFF").bold(DateAndTime));
...
console.log(chalk.bold.hex("#00FFFF").bold("=== APPSTATE - CONFIG ==="));
...
console.log(chalk.bold.hex("#00FFFF").bold(" ===     HORIZON     ==="));
...
(async() => {
    try {
        ...
        onBot(botData);
    } catch (error) { logger(global.getText('mirai', 'successConnectDatabase', JSON.stringify(error)), '[ Haruna ] '); }
  })()
...
CFonts.say(`Bot Messenger Created By Haruna`, {
		font: 'console',
		align: 'center',
		gradient: ['red','magenta',]
		})
